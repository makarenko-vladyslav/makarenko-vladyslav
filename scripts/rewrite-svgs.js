...
fs.writeFileSync(path.join(ASSETS_DIR, 'hero-animated.svg'), premiumHero);
fs.writeFileSync(path.join(ASSETS_DIR, 'link-framer.svg'), makeSocial('FRAMER', ''));
fs.writeFileSync(path.join(ASSETS_DIR, 'link-linkedin.svg'), makeSocial('LINKEDIN', ''));
fs.writeFileSync(path.join(ASSETS_DIR, 'link-telegram.svg'), makeSocial('TELEGRAM', ''));
fs.writeFileSync(path.join(ASSETS_DIR, 'link-facebook.svg'), makeSocial('FACEBOOK', ''));
